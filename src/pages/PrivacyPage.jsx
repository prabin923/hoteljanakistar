                ...
                <div className="container">
                    <div className="legal-wrapper">
                        ...
                        <div className="legal-section">
                            ...
                            <p>Janaki Star Hotel ("we", "our", or "us") is committed to protecting your privacy. This Privacy
                        ...
                        <div className="legal-section">
                            ...
                            <p>We may share your information with third-party service providers who perform services on our
                                behalf, such as payment processing, data analysis, email delivery, and customer service.</p>
                            ...
                            <p>If we are involved in a merger, acquisition, or sale of assets, your information may be
                        ...
                        <div className="legal-section">
                            ...
                            <p>However, no method of transmission over the Internet or electronic storage is 100% secure. While
                        ...
                        <div className="legal-section">
                            ...
                            <p>We retain your personal information only for as long as necessary to fulfill the purposes
                                ...
                                law. When we no longer need your information, we will securely delete or anonymize it.</p>
                        </div>
                        ...
                        <div className="legal-section">
                            ...
                            <ul>
                                ...
                                <li><strong>Objection:</strong> You can object to our processing of your personal information
                                </li>
                                <li><strong>Restriction:</strong> You can request that we restrict the processing of your
                                    information</li>
                                <li><strong>Portability:</strong> You can request a copy of your information in a portable
                                    format</li>
                                <li><strong>Withdrawal of Consent:</strong> You can withdraw your consent at any time where we
                                    relied on your consent to process your information</li>
                            </ul>
                        ...
                        <div className="legal-section">
                            ...
                            <p>We use cookies and similar tracking technologies to track activity on our website and store
                        ...
                        <div className="legal-section">
                            ...
                            <ul>
                                <li><strong>Email:</strong> janakistarhoteljanakpur@gmail.com</li>
                                <li><strong>Phone:</strong> +977 985-4080119</li>
                                <li><strong>Address:</strong> Janakpur, Dhanusha District, Nepal</li>
                            </ul>
                        </div>

                        <div className="legal-footer">
                            <p>By using our website and services, you acknowledge that you have read and understood this Privacy
